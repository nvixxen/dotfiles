...
var SettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Orientation").setDesc("Search images with the specified orientation.").addDropdown((dropdown) => dropdown.addOption("not_specified" /* notSpecified */, "Not Specified").addOption("landscape" /* landscape */, "Landscape").addOption("portrait" /* portrait */, "Portrait").addOption("squarish" /* squarish */, "Squarish").setValue(this.plugin.settings.orientation).onChange(async (value) => {
      if (value === "not_specified" /* notSpecified */ || value === "landscape" /* landscape */ || value === "portrait" /* portrait */ || value === "squarish" /* squarish */) {
...
function getFetcher(settings) {
  ...
  return {
    ...
    async touchDownloadLocation(url) {
      await (0, import_obsidian2.requestUrl)({ url: url.replace("api.unsplash.com", "insert-unsplash-image.cloudy9101.com") });
    },
...
function NoResult() {
  ...
  }, /* @__PURE__ */ React2.createElement("span", null, "OPPS! Nothing Found"));
}
...
var ImagesModal = ({ fetcher, onSelect }) => {
  ...
  }, images.map((image, index) => /* @__PURE__ */ React3.createElement("div", {
  ...
  }, "\u2190 PREV")), /* @__PURE__ */ React3.createElement("div", null, fetcher.hasNextPage() && /* @__PURE__ */ React3.createElement("button", {
    className: "btn",
    disabled: loading,
    tabIndex: -1,
...
// ModalWrapper.tsx
var ModalWrapper = class extends import_obsidian3.Modal {
  ...
  async createFile(name, ext, binary) {
...
// main.ts
var InsertUnsplashImage = class extends import_obsidian4.Plugin {
  async onload() {
    this.loadSettings();
