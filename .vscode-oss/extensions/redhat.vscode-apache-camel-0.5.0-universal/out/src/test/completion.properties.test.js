...
describe('Should do completion in Camel component after "ti"', () => {
    const docUriXml = (0, helper_1.getDocUri)('application.properties');
    const expectedCompletion = [
        { label: 'tika' },
        { label: 'timer' }
    ];
    it('Completes components for application.properties', () => __awaiter(void 0, void 0, void 0, function* () {
        yield testCompletion(docUriXml, new vscode.Position(0, 18), {
