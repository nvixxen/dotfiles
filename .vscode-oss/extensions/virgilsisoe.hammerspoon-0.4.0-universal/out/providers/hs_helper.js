...
exports.HsSignatureHelpProvider = void 0;
const vscode = require("vscode");
const hs = require("../hammerspoon");
const lua = require("../lua_parser");
const utils = require("./utils");
const logger_1 = require("../logger");
const logger = new logger_1.Logger("hsHelper", "hsHelper");
/**
 * Hammerspoon function helper provider.
 */
class HsSignatureHelpProvider {
    constructor() {
     ...
     */
    setArgsCursorPosition(linePrefix, document) {
...
exports.HsSignatureHelpProvider = HsSignatureHelpProvider;
//# sourceMappingURL=hs_helper.js.map