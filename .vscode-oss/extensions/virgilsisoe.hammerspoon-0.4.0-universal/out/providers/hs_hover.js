...
exports.HsHoverProvider = void 0;
const vscode = require("vscode");
const hs = require("../hammerspoon");
const lua = require("../lua_parser");
const utils = require("./utils");
const logger_1 = require("../logger");
const logger = new logger_1.Logger("hsHover", "hsHover");
/**
 * Hammerspoon hover provider.
 */
class HsHoverProvider {
    constructor() {
     ...
     */
    extractHsModule(base, identifier) {
     ...
     * @returns a vscode hover information or null
     */
    extractMethodCallExpression(methodCallExpression) {
     ...
     * @returns a vscode hover information or null
     */
    extractMethodExpression(base, identifier) {
     ...
     * @returns
     */
    extractTableMethodExpression(tableMatch) {
     ...
     * @returns
     */
    extractTableExpression(tableMatch) {
     ...
     * @returns
     */
    getConstructor(base, identifier) {
...
exports.HsHoverProvider = HsHoverProvider;
//# sourceMappingURL=hs_hover.js.map