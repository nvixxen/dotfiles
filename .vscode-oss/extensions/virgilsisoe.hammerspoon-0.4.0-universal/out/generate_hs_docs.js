...
exports.createNewDocs = void 0;
const path = require("path");
const fs_1 = require("fs");
const PATH = "/Applications/Hammerspoon.app/Contents/Resources/docs.json";
const HSDOC = JSON.parse((0, fs_1.readFileSync)(PATH, "utf-8"));
const newDocs = {};
/**
 ...
 * @param module
 */
function createSubModules(base, identifier, module) {
    try {
 ...
 * @returns
 */
function addSubmoduleData(module) {
...
function createNewDocs() {
    ...
    for (const [key, value] of Object.entries(newDocs)) {
        const file = path.join(path.resolve(__dirname, "../"), "resources", "hs_docs", key + ".json");
        (0, fs_1.writeFileSync)(file, JSON.stringify(value));
    }
}
exports.createNewDocs = createNewDocs;
//# sourceMappingURL=generate_hs_docs.js.map