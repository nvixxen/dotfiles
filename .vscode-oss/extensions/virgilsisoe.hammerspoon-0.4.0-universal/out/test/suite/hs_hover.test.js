...
const hsHover = require("../../providers/hs_hover");
...
suite("Hs Hover ", () => {
    ...
    test("Hover on `mainWindow` of: `hs.application():mainWindow`", async () => {
        ...
        assert.ok(provider);
        assert.strictEqual(provider.contents.toString(), testUtils.getDoc("hs.application", "mainWindow"));
    });
    ...
    test("Hover over `getWindow` of: `table[1]:getWindow`", async () => {
        ...
        assert.ok(provider);
        assert.strictEqual(provider.contents.toString(), testUtils.getDoc("hs.application", "getWindow"));
    });
...
//# sourceMappingURL=hs_hover.test.js.map