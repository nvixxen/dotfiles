 ...
 */
function createThemes(config, path) {
    createTheme("Pink Candy Light", "light", "pink-candy-light.json", path, light_1.lightColors, light_1.lightSyntax, config);
    createTheme("Pink Candy Dark", "dark", "pink-candy-dark.json", path, dark_1.darkColors, dark_1.darkSyntax, config);
}
exports.createThemes = createThemes;
function createTheme(name, type, file, themeFolder, color, syntax, config) {
...
function generateTheme(color, syntax, name, type, config) {
    ...
    return {
        ...
        colors: {
            ...
            //
            // GENERAL TEXT
            "textLink.foreground": color.accent.primary,
            "textLink.activeForeground": color.accent.linkHover,
            descriptionForeground: color.text.light,
            "textPreformat.foreground": color.accent.secondary,
            ...
            //
            // SETTINGS PAGE [x]
            "settings.headerForeground": color.text.normal,
        ...
        semanticTokenColors: {
            ...
            //
            variable: syntax.var,
            "local:csharp": syntax.var,
            parameter: syntax.parameter,
            property: syntax.member,
            "field:csharp": syntax.member,
            "field.static:csharp": {
            ...
            "variable.static:csharp": syntax.constant,
            "variable.readonly:csharp": syntax.constant,
            "variable.readonly:javascript": syntax.constant,
            "variable.readonly:typescript": syntax.constant,
            //
            //
...
function markdownStyles(syntax, alternate) {
    let styles = [];
    if (alternate) {
        styles.push({
