...
- Feature: Support config the path(absolute or relative) to save image.(@ysknkd in [#4](https://github.com/mushanshitiancai/vscode-paste-image/issues/4))
...
- Feature: Add windows support by powershell(@kivle in [#2](https://github.com/mushanshitiancai/vscode-paste-image/issues/2))
