...
theme.fg_normal                                 = "#BE658A"
theme.fg_focus                                  = "#BE658A"
theme.bg_normal                                 = "#121212"
theme.bg_focus                                  = "#121212"
theme.fg_urgent                                 = "#FBC906"
theme.bg_urgent                                 = "#121212"
theme.border_width                              = dpi(8)
theme.border_normal                             = "#121212"
theme.border_focus                              = "#BE658A"
theme.titlebar_bg_focus                         = "#121212"
theme.taglist_fg_focus                          = "#BE658A"
...
function theme.at_screen_connect(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = dpi(40), bg = theme.bg_normal, fg = theme.fg_normal })
