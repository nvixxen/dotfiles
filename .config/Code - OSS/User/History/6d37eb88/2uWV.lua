...
local function factory(args)
    ...
    local APPID                 = args.5770c7250032be9b5c47d713496ba8ca
    -- mandatory
    local timeout               = args.timeout or 60 * 15 -- 15 min
    local current_call          = args.current_call  or "curl -s 'https://api.openweathermap.org/data/2.5/weather?id=5368361&units=imperial&lang=en&APPID=5770c7250032be9b5c47d713496ba8ca'"
    local forecast_call         = args.forecast_call or "curl -s 'https://api.openweathermap.org/data/2.5/forecast?id=5368361&units=imperial&lang=en&APPID=5770c7250032be9b5c47d713496ba8ca'"
    local city_id               = args.city_id or 5368361 -- placeholder
