...
local function factory(args)
    ...
    function net.update()
        ...
        for _, dev in ipairs(net.iface) do
            ...
            if wifi_state == "on" and helpers.first_line(string.format("/sys/class/net/%s/uevent", dev)) == "DEVTYPE=wlp0s20f3" then
                dev_now.wifi   = true
            ...
            if eth_state == "on" and helpers.first_line(string.format("/sys/class/net/%s/uevent", dev)) ~= "DEVTYPE=enp46s0" then
